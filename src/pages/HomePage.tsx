...
const HomePage = () => {
    ...
    return (
        <>
            <div className={`fixed flex justify-center items-center h-screen w-screen top-0 left-0 bg-black/50 z-20 ${showAddCharacter ? '' : "hidden"}`}>
                <div className="flex justify-center items-center relative w-1/4 gap-8 p-8 bg-white rounded ">
                    <button className="absolute top-2 right-3 cursor-pointer hover:text-red-500" onClick={() => setShowAddCharacter(false)}>
                        X
                    </button>
                    <form onSubmit={(e) => {
                        e.preventDefault()
            ...
            <div>
                <div className="container w-3xl mx-auto p-4 mt-10  ">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button onClick={() => setShowAddCharacter(true)} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Data</button>
                    </div>
